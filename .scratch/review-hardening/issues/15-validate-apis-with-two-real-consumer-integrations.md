...
**What to build:** The current APIs should be exercised by real consumer code before the project adds more public vocabulary or module families outside the required `ld_desktop` and `ld_migration` extractions.
