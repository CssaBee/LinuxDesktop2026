...
**What to build:** The project documentation should clearly distinguish prototype evidence from production-ready behavior, so readers can tell which library behavior is demonstrated, which is still hardening, and which roadmap items are only research notes.
