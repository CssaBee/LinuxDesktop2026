...
| Migration filesystem semantics | Regular-file and supported directory-tree migration are in scope. Directory moves verify copied content before source cleanup. Cross-device semantic file moves remain excluded unless maintained consumer evidence proves the need. |
