...
enum ld_paths_path_family {
    ...
    LD_PATHS_FAMILY_PUBLIC_SHARE = 11,
    LD_PATHS_FAMILY_EXECUTABLE = 12,
    LD_PATHS_FAMILY_EXECUTABLE_DIRECTORY = 13,
    LD_PATHS_FAMILY_INSTALL_PREFIX = 14,
    LD_PATHS_FAMILY_RESOURCES = 15,
    LD_PATHS_FAMILY_PLUGIN_SEARCH = 16
};
